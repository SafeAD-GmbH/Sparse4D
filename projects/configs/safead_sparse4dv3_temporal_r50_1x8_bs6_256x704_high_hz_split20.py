...
num_iters_per_epoch = int(66413 // (num_gpus * batch_size))
num_epochs = 50  # could be 16 => 200 * (66413/5540)
...
fp16 = dict(
    loss_scale=dict(init_scale=128.)
)  # should pass as dict otherwise mmcv forces that scale after every update [disabling scaling depending on gradients]
input_shape = (704, 256)
...
model = dict(
    ...
    head=dict(
        ...
        instance_bank=dict(
            ...
            num_anchor=900,
            embed_dims=embed_dims,
            anchor="safead_kmeans900.npy",
            anchor_handler=dict(type="SparseBox3DKeyPointsGenerator"),
            num_temp_instances=600 if temporal else -1,
            confidence_decay=0.6,
            default_time_interval=0.04,
            feat_grad=False,
        ),
        anchor_encoder=dict(
...
# ================== data ========================
dataset_type = "SafeAD3DDetTrackDataset"
data_root = "data/nuscenes/"
anno_root = "data/nuscenes_cam/"
anno_root = "/home/goel/carnet/worktrees/obj-stream/data-new/"
...
data = dict(
    ...
    train=dict(
        **data_basic_config,
        ann_file=anno_root + "safead-2hz-track_infos_temporal_high_hz_seq_train.pkl",
        pipeline=train_pipeline,
        test_mode=False,
        data_aug_conf=data_aug_conf,
        with_seq_flag=True,
        sequences_split_num=20,
        keep_consistent_seq_aug=True,
    ),
    val=dict(
        **data_basic_config,
        ann_file=anno_root + "safead-2hz-track_infos_temporal_val.pkl",  # make this high hz as well
...
evaluation = dict(
    interval=200 * num_iters_per_epoch * checkpoint_epoch_interval,
