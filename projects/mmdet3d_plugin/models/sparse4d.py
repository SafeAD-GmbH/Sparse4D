...
class Sparse4D(BaseDetector):
    ...
    def forward_onnx(self, img, timestamp, projection_mat, image_wh):
        return self.forward_test(img, timestamp=timestamp, projection_mat=projection_mat, image_wh=image_wh)
